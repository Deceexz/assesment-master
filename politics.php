...
<div class="top-category-bar">
  ...
  <a href="politics.php" class="category-btn active">Politics</a>
    ...
    <div class="col-sm-8">
      <div class="container">
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<div class="article-card">';
              ...
              echo '<div class="article-content">';
                echo '<h3><a href="full_article.php?post_id=' . $row['post_id'] . '&from=politics">' . $row['title'] . '</a></h3>';
                ...
                if (isset($_SESSION['user_id'])) {
                  ...
                  echo '<form method="POST" action="politics.php?page=' . $page . ($search ? '&search=' . urlencode($search) : '') . '">';
          ...
          echo '<p>Tidak ditemukan artikel politik.</p>';
        }
        ?>
